...
const styles = StyleSheet.create({
  ...
  auditSummary: { flexDirection: 'row', gap: Spacing.sm, marginBottom: Spacing.lg },
  pill: { flex: 1, alignItems: 'center', paddingVertical: Spacing.sm, borderWidth: 1 },
  ...
  cardHeader: { flexDirection: 'row', alignItems: 'center', gap: Spacing.md, paddingVertical: Spacing.md },
  swatch: { width: 48, height: 56, alignItems: 'center', justifyContent: 'center' },
  ...
  verdictRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 4, marginTop: 2 },
  verdictBadge: { paddingHorizontal: 6, paddingVertical: 2, backgroundColor: Colors.surfaceLight },
  ...
  expanded: { paddingBottom: Spacing.md, paddingLeft: 64, gap: Spacing.sm },
  impact: { fontSize: FontSize.xs, color: Colors.textSecondary, lineHeight: 18, fontStyle: 'italic' },
