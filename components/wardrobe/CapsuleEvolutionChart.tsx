...
const styles = StyleSheet.create({
  ...
  summaryRow: { flexDirection: 'row', borderWidth: 1, borderColor: Colors.border, borderRadius: BorderRadius.lg, marginBottom: Spacing.md, overflow: 'hidden' },
  ...
  listTitle: { fontSize: 10, fontWeight: FontWeight.bold, color: Colors.textMuted, letterSpacing: 1.5, marginBottom: Spacing.sm },
  snapRow: { flexDirection: 'row', alignItems: 'center', gap: Spacing.md, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: Colors.border },
  snapDot: { width: 8, height: 8, borderRadius: BorderRadius.full },
  snapInfo: { flex: 1 },
  ...
  snapScore: { fontSize: FontSize.md, fontWeight: FontWeight.bold, color: Colors.textSecondary },
